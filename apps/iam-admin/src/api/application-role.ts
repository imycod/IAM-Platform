...
export const createApplicationRole = (applicationId: string, data: ApplicationRoleForm) =>
  http
...
export const updateApplicationRole = (
  ...
  http
    .request<unknown>("patch", `/api/applications/${applicationId}/roles/${id}`, { data })
    .then(body => unwrapIamPayload<ApplicationRoleItem>(body));

export const getApplicationRolePermissions = (applicationId: string, id: string) =>
  http
...
export const setApplicationRolePermissions = (
  ...
  http
    .request<unknown>("put", `/api/applications/${applicationId}/roles/${id}/permissions`, {
      data: { permissionIds }
    })
    .then(body => unwrapIamPayload<ApplicationRoleItem>(body));

export const deleteApplicationRole = (applicationId: string, id: string) =>
  http.request<unknown>("delete", `/api/applications/${applicationId}/roles/${id}`);
