...
import { DataPermissionFilterResolver } from './services/data-permission-filter.resolver';
...
export { DataPermissionFilterResolver } from './services/data-permission-filter.resolver';
...
@Module({
  ...
  providers: [DataPermissionService, DataPermissionFilterResolver],
  exports: [DataPermissionService, DataPermissionFilterResolver],
})
